...
@section('content')
    ...
    <div class="content">
        ...
        <!-- <a class="button is-link" target="_blank" href="/vehicles/{{ $vehicle->uuid }}/generateqr">Gerar QrCode</a> -->
        <a class="button is-link" target="_blank" href="/vehicles/{{ $vehicle->uuid }}/generate-pdf">Gerar QrCode</a>
