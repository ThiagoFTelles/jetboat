...
<body>
    ...
    <?php
    $name =  substr($vehicle->owner_name, 0, 11);
    $uuid = $vehicle->uuid;
    ...
    $style = "<div style=\"position: absolute; left:0;top:0;display:block;margin:0; padding:0; border:none;font-family: Arial, Helvetica, sans-serif; text-transform: uppercase; font-size:45px; text-align:center; width:100%; height:100%\"><br><div style = \"margin:0; padding:0; border:none;width:auto; height:auto\">$name</div><img stye=\"\" ";

    echo $style;
    echo " src=\"data:image/png;base64, ";
    echo base64_encode(QrCode::format('png')->merge($logo, 0.2, true)->size(400)->errorCorrection('H')->margin(0)->generate($uuid));
    echo "\"></div>";
