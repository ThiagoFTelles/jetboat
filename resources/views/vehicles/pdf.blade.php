...
<body>
            ...
            <?php
                ...
                $style = "<div style=\"position: absolute; left:0;top:0;display:block;margin:0; padding:0; border:0;font-family: Arial, Helvetica, sans-serif; text-transform: uppercase; font-size:45px; text-align:center; width:100%; height:100%\"><br><div style = \"margin:0; padding:0; border:0;\">$name</div><img stye=\"\" ";
